...
public class CommandTestUtil {
    ...
    public static final LocalDate VALID_START_DATE_AMY = LocalDate.parse("2021-10-05",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate VALID_END_DATE_AMY = LocalDate.parse("2021-10-10",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate VALID_START_DATE_BOB = LocalDate.parse("2021-12-12",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate VALID_END_DATE_BOB = LocalDate.parse("2021-12-12",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate CONFLICT_AMY_START_DATE_CHLOE = LocalDate.parse("2021-10-06",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate CONFLICT_AMY_END_DATE_CHLOE = LocalDate.parse("2021-10-09",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate VALID_START_DATE_DAN = LocalDate.parse("2021-11-11",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    public static final LocalDate VALID_END_DATE_DAN = LocalDate.parse("2021-11-21",
            DateTimeFormatter.ofPattern("yyyy-MM-dd"));
