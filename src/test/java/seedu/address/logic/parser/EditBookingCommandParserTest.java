...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_ROOM_ID_DESC2;
...
import static seedu.address.logic.commands.CommandTestUtil.ROOM_ID_DESC_BOB;
...
public class EditBookingCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + ROOM_ID_DESC_AMY, MESSAGE_INVALID_FORMAT);

        // zero index
        assertParseFailure(parser, "0" + ROOM_ID_DESC_AMY, MESSAGE_INVALID_FORMAT);
    ...
    public void parse_invalidValue_failure() {
        assertParseFailure(parser, "1" + INVALID_ROOM_ID_DESC2, MESSAGE_INVALID_ROOM_ID); // invalid room id
        assertParseFailure(parser, "1" + INVALID_START_DATE_DESC, MESSAGE_INVALID_DATE); // invalid start date
        assertParseFailure(parser, "1" + INVALID_END_DATE_DESC, MESSAGE_INVALID_DATE); // invalid end date

        // invalid room id followed by valid start date
        assertParseFailure(parser, "1" + INVALID_ROOM_ID_DESC2 + START_DATE_DESC_AMY, MESSAGE_INVALID_ROOM_ID);

        // valid room id followed by invalid room id. The test case for invalid room id followed by valid room id
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        assertParseFailure(parser, "1" + ROOM_ID_DESC_AMY + INVALID_ROOM_ID_DESC2, MESSAGE_INVALID_ROOM_ID);

        // multiple invalid values, but only the first invalid value is captured
        assertParseFailure(parser, "1" + INVALID_ROOM_ID_DESC2 + INVALID_START_DATE_DESC
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + ROOM_ID_DESC_AMY + END_DATE_DESC_AMY + START_DATE_DESC_AMY;
    ...
    public void parse_someFieldsSpecified_success() {
        Index targetIndex = INDEX_SECOND_BOOKING;
        String userInput = targetIndex.getOneBased() + ROOM_ID_DESC_AMY + END_DATE_DESC_AMY;
    ...
    public void parse_oneFieldSpecified_success() {
        // room id
        Index targetIndex = INDEX_SECOND_BOOKING;
        String userInput = targetIndex.getOneBased() + ROOM_ID_DESC_AMY;
        EditBookingCommand.EditBookingDescriptor descriptor = new EditBookingDescriptorBuilder()
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_SECOND_BOOKING;
        String userInput = targetIndex.getOneBased() + ROOM_ID_DESC_BOB + START_DATE_DESC_BOB + END_DATE_DESC_BOB
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        String userInput = targetIndex.getOneBased() + INVALID_ROOM_ID_DESC2 + ROOM_ID_DESC_BOB;
        EditBookingCommand.EditBookingDescriptor descriptor = new EditBookingDescriptorBuilder()
        ...
        userInput = targetIndex.getOneBased() + START_DATE_DESC_BOB + INVALID_ROOM_ID_DESC2 + END_DATE_DESC_BOB
                + ROOM_ID_DESC_BOB;
